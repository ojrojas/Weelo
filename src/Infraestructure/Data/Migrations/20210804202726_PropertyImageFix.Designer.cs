...
namespace Weelo.Infraestructure.Data.Migrations
{
    ...
    [Migration("20210804202726_PropertyImageFix")]
    partial class PropertyImageFix
    {
            ...
            modelBuilder.Entity("Weelo.Core.Entities.PropertyImage", b =>
                {
                    b.HasOne("Weelo.Core.Entities.Property", "Property")
                        ...
                        .HasForeignKey("Weelo.Core.Entities.PropertyImage", "PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Weelo.Core.Entities.PropertyTrace", b =>
                {
                    b.HasOne("Weelo.Core.Entities.Property", "Property")
                        ...
                        .HasForeignKey("Weelo.Core.Entities.PropertyTrace", "PropertyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
