...
namespace Tests.Endpoints.OwnerEndpoint
{
    public class List : IClassFixture<ApiTestFixture>
    {
        ...
        [Fact]
        public async Task ReturnListOwnerWithoutAuthentication()
        {
        ...
        [Fact]
        public async Task ReturnListOwnerWithAuthentication()
        {
            ...
            var model = JsonConvert.DeserializeObject<ListOwnerResponse>(stringResponse, _serializerSettings);

            Assert.IsType<List<OwnerDto>>(model.Owners);
        }
